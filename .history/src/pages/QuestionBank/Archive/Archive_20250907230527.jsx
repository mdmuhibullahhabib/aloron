...
// Faculties Data (Institution Wise)
const facultiesData = {
  bup: [
  ...
  buet: [
    { title: "Engineering", subtitle: "All Units", color: "#ef4444" },
    { title: "Architecture", subtitle: "Special Unit", color: "#8b5cf6" },
  ],
  cuet: [
    { title: "Engineering", subtitle: "Civil, EEE, CSE", color: "#3b82f6" },
  ],
  kuet: [
    { title: "Engineering", subtitle: "Mechanical, EEE, CSE", color: "#4d7c0f" },
  ],
  ruet: [
    { title: "Engineering", subtitle: "Civil, Mechanical, EEE", color: "#f97316" },
  ]
};
      ...
      {activeTab === 'institution-based' && selectedInstitution ? (
        <div className="mt-6">
          <h2 className="text-2xl font-bold mb-6">
            Faculties for {selectedInstitution?.toUpperCase()}
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {(facultiesData[selectedInstitution] || []).map((faculty, idx) => (
              <Link
                key={idx}
            ...
            <div
              ...
              onClick={() => {
                if (activeTab === 'institution-based') {
                  setSelectedInstitution(card.path); 
                }
              }}
            >
