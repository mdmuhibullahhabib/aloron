...
const facultiesData = {
  "math-1": [
    { title: "Academic", subtitle: "Math 1st", color: "#3b82f6", path: "math-1st-paper-academic" },
    { title: "Mainbook", subtitle: "Math 1st", color: "#ef4444", path: "math-1st-paper-varsity" },
    { title: "Engineering", subtitle: "Math 1st", color: "#f59e0b", path: "math-1st-paper-engineering" },
    { title: "Medical", subtitle: "Math 1st", color: "#10b981", path: "math-1st-paper-medical" },
  ],
  "math-2": [
    { title: "Academic", subtitle: "Math 2nd", color: "#3b82f6" },
    { title: "Mainbook", subtitle: "Math 2nd", color: "#ef4444" },
    { title: "Engineering", subtitle: "Math 2nd", color: "#f59e0b" },
    { title: "Medical", subtitle: "Math 2nd", color: "#10b981" },
  ],
  "physics-1": [
    { title: "Academic", subtitle: "Physics 1st", color: "#3b82f6" },
    { title: "Mainbook", subtitle: "Physics 1st", color: "#ef4444" },
    { title: "Engineering", subtitle: "Physics 1st", color: "#f59e0b" },
    { title: "Medical", subtitle: "Physics 1st", color: "#10b981" },
  ],
  "physics-2": [
    { title: "Academic", subtitle: "Physics 2nd", color: "#3b82f6" },
    { title: "Mainbook", subtitle: "Physics 2nd", color: "#ef4444" },
    { title: "Engineering", subtitle: "Physics 2nd", color: "#f59e0b" },
    { title: "Medical", subtitle: "Physics 2nd", color: "#10b981" },
  ],
  "chemistry-1": [
    { title: "Academic", subtitle: "Chemistry 1st", color: "#3b82f6" },
    { title: "Mainbook", subtitle: "Chemistry 1st", color: "#ef4444" },
    { title: "Engineering", subtitle: "Chemistry 1st", color: "#f59e0b" },
    { title: "Medical", subtitle: "Chemistry 1st", color: "#10b981" },
  ],
  "chemistry-2": [
    { title: "Academic", subtitle: "Chemistry 2nd", color: "#3b82f6" },
    { title: "Mainbook", subtitle: "Chemistry 2nd", color: "#ef4444" },
    { title: "Engineering", subtitle: "Chemistry 2nd", color: "#f59e0b" },
    { title: "Medical", subtitle: "Chemistry 2nd", color: "#10b981" },
  ],
  "biology-1": [
    { title: "Academic", subtitle: "Biology 1st", color: "#3b82f6" },
    { title: "Mainbook", subtitle: "Biology 1st", color: "#ef4444" },
    { title: "Engineering", subtitle: "Biology 1st", color: "#f59e0b" },
    { title: "Medical", subtitle: "Biology 1st", color: "#10b981" },
  ],
  "biology-2": [
    { title: "Academic", subtitle: "Biology 2nd", color: "#3b82f6" },
    { title: "Mainbook", subtitle: "Biology 2nd", color: "#ef4444" },
    { title: "Engineering", subtitle: "Biology 2nd", color: "#f59e0b" },
    { title: "Medical", subtitle: "Biology 2nd", color: "#10b981" },
  ],
  du: [
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {faculties.length > 0 ? (
          faculties.map((f, idx) => (
            <Link
              key={idx}
              to={`/question-bank/archive/${f.path}`}
