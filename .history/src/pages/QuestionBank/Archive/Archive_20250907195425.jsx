...
const cardData = {
  'model-test': [
    { title: 'বিবরণী ২৫', subtitle: 'প্রাইভেট এডমিশন', path: 'bibrani-25-private', color: '#8b5cf6' },
    { title: 'বিবরণী ২৫', subtitle: 'ফিজিক্যাল এডমিশন', path: 'bibrani-25-physical', color: '#10b981' },
  ],
  'subject-based': [
    { title: 'বাংলা', subtitle: '১ম পত্র', path: 'bangla-1', color: '#f97316' },
    { title: 'ইংরেজি', subtitle: '২য় পত্র', path: 'english-2', color: '#8b5cf6' },
  ],
  'institution-based': [
    { title: 'মেডিকেল ও ডেন্টাল', subtitle: 'প্রাইভেট', path: 'medical', color: '#4d7c0f', institution: 'medical' },
    { title: 'বিইউপি', subtitle: 'এডমিশন', path: 'bup', color: '#10b981', institution: 'bup' },
  ]
};
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {(activeTab === 'all'
            ...
            <div
              ...
              onClick={() => card.institution && setSelectedInstitution(card.institution)}
            >
