...
const cardData = {
  ...
  'subject-based': [
    { id: 5, title: 'বাংলা', subtitle: '১ম পত্র', path: 'bangla-1', color: '#f97316', institution:'bangla'},
  ...
  'institution-based': [
    ...
    { id: 16, title: 'বিইউপি', subtitle: 'এডমিশন', path: 'bup', color: '#10b981',  institution:'bangla' },
