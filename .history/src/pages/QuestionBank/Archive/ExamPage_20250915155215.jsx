...
const ExamPage = () => {
  ...
  const [unlocked, setUnlocked] = useState({}); // ✅ CHANGE-1: unlocked state
        ...
        questions: [
          {
            ...
            explanation: "মৌলিক রাশি হলো যেগুলো অন্য কোনো রাশি দিয়ে প্রকাশ করা যায় না। ঘনত্ব ভর ও আয়তনের উপর নির্ভরশীল, তাই এটি মৌলিক নয়।", // ✅ CHANGE-2: explanation field
          },
          {
            _id: "q2",
            ...
            tag: "RU C 16-17",
            topic: "পরিমাপ",
            explanation: "১ Å (অ্যাংস্ট্রম) = 10⁻¹⁰ মিটার, এটি সাধারণত পরমাণুর ব্যাস বা ছোট মাপ বোঝাতে ব্যবহৃত হয়।", // ✅ CHANGE-2
          },
        ],
      };
        ...
        {questions.map((q) => (
          ...
          >
            ...
            <div className="btn w-full mt-2">
              {!unlocked[q._id] ? (
                <button
                  onClick={() => handleUnlock(q._id)}
                  className="text-center flex items-center text-blue-600 hover:text-blue-800"
                >
                  <FaLock className="mt-1 mr-2" /> ব্যাখ্যা আনলক করতে আলোড়ন
                  প্রিমিয়াম এ আপগ্রেড করো
                </button>
              ) : (
                <p className="mt-3 p-3 bg-yellow-50 border-l-4 border-yellow-400 text-yellow-700 rounded">
                  {q.explanation}
                </p>
              )}
            </div>
