...
const cardData = {
  "model-test": [
    ...
    { id: 2, title: "এইচএসসি ২৫", subtitle: "কুইজ এন্ড এডমিশন", path: "hsc-25-quiz", color: "#ef4444" },
  ],
  "subject-based": [
    { id: 3, title: "বাংলা ১ম পত্র", subtitle: "Chapter 1-10", path: "bangla-1", color: "#f97316" },
    { id: 4, title: "বাংলা ২য় পত্র", subtitle: "Chapter 11-20", path: "bangla-2", color: "#ca8a04" },
  ],
  "institution-based": [
    { id: 5, title: "BUET", subtitle: "Engineering", path: "buet", color: "#3b82f6" },
    { id: 6, title: "Medical College", subtitle: "MBBS", path: "medical", color: "#4d7c0f" },
  ],
};
    ...
    <div className="p-6 max-w-7xl mx-auto">
        ...
        {tabs.map((tab) => (
          <button
            ...
            className={`px-5 py-2 rounded-full font-semibold ${
              activeTab === tab ? "bg-emerald-500 text-white" : "bg-gray-100 text-gray-700"
            }`}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {cardsToShow.map((card) => (
          <Link
            key={card.id}
            to={`/question-bank/archive/${activeTab}/${card.path}`} // ডাইনামিক নেভিগেশন
