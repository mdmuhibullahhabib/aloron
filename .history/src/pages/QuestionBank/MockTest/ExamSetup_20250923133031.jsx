  ...
  return (
    <div className="p-8 rounded-xl shadow-md">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="p-4 rounded-xl text-center">
          <p className="">নেগেটিভ মার্কিং</p>
          <input type="checkbox" checked={negativeMarking} onChange={() => setNegativeMarking(!negativeMarking)} className="mt-2" />
        </div>
      </div>
      <div className="mb-6">
        <h3 className="text-lg font-semibold">নির্বাচিত অধ্যায় (মোট {selectedChapters.length})</h3>
        <p className="">{selectedChapters.join(', ') || 'কোনো অধ্যায় নির্বাচন করা হয়নি'}</p>
      </div>
      <button
