        ...
        {dummyQuestions.map((q, index) => (
          <div key={q.id} className="bg-white p-6 rounded-xl shadow">
            ...
            <div className="flex justify-end mt-4 gap-3">
              ...
              <button 
                className="px-4 py-2 bg-blue-200 rounded-lg hover:bg-blue-300 text-gray-800 font-medium"
            ...
            {expandedIds.includes(q.id) && (
              <div className="mt-4 p-4 bg-gray-100 rounded-lg">
                <p className="text-gray-700">Correct Answer: <span className="font-semibold">{q.correctAnswer}</span></p>
                <p className="text-gray-700 mt-1">Your Answer: <span className="font-semibold">{userAnswers[index] || 'Not Answered'}</span></p>
                <p className="text-gray-600 mt-2 text-sm">Explanation / Notes can go here...</p>
              </div>                      
            )}
          </div>
        ))}                                                                                                                                                                             
