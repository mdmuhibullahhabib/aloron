...
const FilterSection = () => {
    ...
    const filterData = {
        ...
        chapter: [
            { id: '1', label: 'বল' },
            { id: '2', label: 'কাজ, শক্তি ও ক্ষমতা' },
            { id: '3', label: 'মহাকর্ষ' },
            { id: '4', label: 'আলোকবিজ্ঞান' }
        ],
        topic: [
    ...
    return (
        <div className="filter-section bg-white p-4 rounded-lg shadow-lg my-4 transition-all duration-300">
            ...
            <div className="flex justify-start items-center space-x-4 mb-4">
                ...
                <div onClick={() => handleFilterClick('chapter')} className="bg-white text-gray-700 font-medium py-2 px-4 rounded-full border border-gray-300 cursor-pointer flex items-center">
                    <span>অধ্যায়</span>
                    <i className="fas fa-chevron-down ml-2 text-xs"></i>
                </div>
