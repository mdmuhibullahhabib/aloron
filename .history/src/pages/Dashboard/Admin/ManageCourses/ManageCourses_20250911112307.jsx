...
import useAxiosSecure from "../../../../hooks/useAxiosSecure"; // JWT বা Auth Axios
import CourseCurriculumModal from "./CourseCurriculumModal";
import CourseStudentsModal from "./CourseStudentsModal";
import CourseEditModal from "./CourseEditModal";

const ManageCourses = () => {
  const axiosSecure = useAxiosSecure(); // ব্যাকএন্ড কলের জন্য
  ...
  const updateCourseStatus = async (courseId, status) => {
    try {
      ...
      await axiosSecure.patch(`/courses/${courseId}`, { status });
