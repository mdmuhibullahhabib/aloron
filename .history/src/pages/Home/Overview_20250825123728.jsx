...
const Overview = () => {
  return (
    <div className="bg-[#121212] flex gap-4 border-2">
    <div className="bg-[#1b1b1b] text-white py-16 px-6 md:px-20 lg:px-32">
    ...
    <div className="bg-[#1b1b1b] text-white py-16 px-6 md:px-20 lg:px-32">
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        {/* Left Text Section */}
        <div className="text-center md:text-left max-w-md">
          <h2 className="text-3xl sm:text-4xl font-bold mb-4">মফলাফল বিশ্লেষণ</h2>
          <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
            নিজের ইচ্ছেমতো বিষয়, টপিক, সময় ও প্রশ্ন সংখ্যা নির্বাচন করে মক পরীক্ষা নেবার সুযোগ।
          </p>
