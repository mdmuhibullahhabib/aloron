...
const SignUp = () => {
  ...
  <div className="bg-[#1e1e1e] text-white rounded-lg shadow-lg flex flex-col md:flex-row w-full max-w-5xl overflow-hidden">
    {/* Left Side Graphic */}
    <div className="hidden md:flex items-center justify-center bg-[#0f3c36] w-1/2 p-10 relative">
      <img
    ...
    <div className="w-full md:w-1/2 p-8">
      ...
      <form onSubmit={handleSignup} className="space-y-4">
        <input
          ...
          className="input input-bordered w-full bg-[#2a2a2a] border-gray-700 text-white placeholder-gray-400"
          required
        />
        <input
          type="email"
