    ...
    return (
        <header className="bg-white shadow-md p-4 flex justify-between items-center rounded-b-lg">
            ...
            <div className="flex items-center space-x-4">
                <a href="#" className="text-gray-600 hover:text-blue-500">প্রবেশক জ্ঞান</a>
                <a href="#" className="text-gray-600 hover:text-blue-500">পরীক্ষা</a>
                <a href="#" className="text-gray-600 hover:text-blue-500">PDF</a>
                <a href="#" className="text-gray-600 hover:text-blue-500">লবণ</a>
                <a href="#" className="text-gray-600 hover:text-blue-500">শেয়ার</a>
                <button className="bg-white text-blue-500 font-semibold py-2 px-4 rounded-full border border-blue-500 hover:bg-blue-500 hover:text-white transition duration-300">
                    Log In
                </button>
                <button className="bg-red-500 text-white font-semibold py-2 px-4 rounded-full shadow-lg hover:bg-red-600 transition duration-300">
                    Sign Up
                </button>
            </div>
        </header>
