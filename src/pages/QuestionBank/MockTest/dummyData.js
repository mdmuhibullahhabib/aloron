// src/components/Mocktest/dummyData.js
...
export const presetExams = [
  'SUST A', 'SUST B', 'BUET A', 'BUP FSSS/FASS', 'RU A', 'KUET', 'RUET', 'CUET'
];

export const dummyQuestions = [
  {
    id: 1,
    text: 'ক্রোমিয়ামের ইলেকট্রন বিন্যাস-',
    options: ['3d⁵4s¹', '3d⁴4s²', '3d⁵4s²', '3d⁴4s¹'],
    correctAnswer: '3d⁵4s¹',
  },
  {
    id: 2,
    text: 'P মৌলের পারমাণবিক ভর 31 এবং পারমাণবিক সংখ্যা 15 হলে নিউট্রন সংখ্যা কতটি?',
    options: ['31', '16', '33', '15'],
    correctAnswer: '16',
  },
  {
    id: 3,
    text: '¹²₆C + ¹₁H → ¹³₇N + 🞎, 🞎 চিহ্নিত স্থানে কী হবে?',
    options: ['¹₀H', '³₁H', '¹₁H', '¹₀n'],
    correctAnswer: '¹₀n',
  },
];
